  ...
  return (
    <footer className="school-footer">
      <div className="container-fluid">
        <div className='row flex justify-content-center px-5' style={{ paddingTop: '6rem', paddingBottom: '6rem' }}>
          ...
          <div className="col-md-3 col-12 flex flex-column gap-4 footer-block pb-5">
            <h3 className='footer-title'>Get In Touch</h3>
            <p>123 Main street, 2nd block <br/> Opposite some landmark <br/>P.O - Wakka, P.S - Wakka,<br/> Wakka - 123456, Arunachal Pradesh</p>
            <div className='flex gap-3 align-items-center'><FontAwesomeIcon icon={faPhone} className='text-warning' />+917003477678, +919876234567</div>
            <div className='flex gap-3 align-items-center'><FontAwesomeIcon icon={faEnvelope} className='text-warning' />info@gmail.com</div>
          </div>
